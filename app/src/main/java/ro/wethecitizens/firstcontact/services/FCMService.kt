...
import ro.wethecitizens.firstcontact.services.BluetoothMonitoringService.Companion.PUSH_NOTIFICATION_ID
...
class FCMService : FirebaseMessagingService() {
    ...
    override fun onMessageReceived(remoteMessage: RemoteMessage) {
        ...
        if (remoteMessage.data.isNotEmpty()) {
            ...
            ro.wethecitizens.firstcontact.Preference.putAnnouncement(baseContext, body)
        }
    ...
    private fun sendNotification(
        ...
        val intent = Intent(this, ro.wethecitizens.firstcontact.SplashActivity::class.java)
